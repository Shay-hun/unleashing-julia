...
# ╔═╡ e207afe6-b549-49d0-8894-af917165f913
begin
	using DataFrames
	using CSV
end

# ╔═╡ c01df532-526b-492f-8c14-4c44fb1beaae
using PlutoUI

# ╔═╡ ff050f99-e212-431a-b68e-f54c4a340542
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 2500bf5a-baf4-41b3-95ce-743827a68fe7
df.Country_code === df[!, "Country_code"]

# ╔═╡ 15c6b6be-732d-431e-91af-4a9b2f9b4014
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 2f017599-087f-40d3-9eca-98c237f32ad2
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 76e7c10d-8893-4062-905d-d72c956c24c0
begin
...
# ╔═╡ 8eb0bfdf-99b3-4e8b-9321-534da384bced
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ a0b37a8a-6684-4ced-9f3c-d9d31d986a27
...
# ╔═╡ 9c2239ef-8f37-4e2b-879e-fb55b63eff88
@bind slider_value Slider(0:10:1000)

# ╔═╡ fe7937a5-5f51-47bb-a093-3233c35120a1
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ ebfca19b-07e1-4768-8635-ef19eec13a5c
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 7f7b120b-f62c-4c5b-aabe-6f35d43420ac
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 9a120041-fcd1-4e83-9fdb-a2ee0a53b59f
